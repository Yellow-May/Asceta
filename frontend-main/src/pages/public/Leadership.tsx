  ...
  const leadership = [
    {
      ...
      position: 'Provost',
      image: 'https://asceta.edu.ng/wp-content/uploads/2024/11/provost.jpg',
    ...
    },
    {
      ...
      image: 'https://images.unsplash.com/photo-1494790108377-be9f29c6d0c7?w=400',
        ...
        {leadership.map((leader, index) => (
          ...
          >
            ...
            <div className="flex-1">
              ...
              <p className="text-xl text-asceta-green font-semibold mb-4">{leader.position}</p>
              ...
              <div className="mt-4">
                <p className="text-gray-600">
                  ...
                  <a
                    ...
                    className="text-asceta-green hover:underline"
                  >
                    {leader.email}
                  </a>
                </p>
